...
const apiServer = "https://beta.api.selfservice.intensive.int";
const apiVersion = "v1";
const azureAppId = 'e4af89f8-a04d-47dc-94f3-daae306db79f';
const azureTenantId = '570057f4-73ef-41c8-bcbb-08db2fc15c2b';

export const environment = {
  production: true,
  siteTitle: "Intensive Self-Service Portal(BETA)",
  appVersion: version,
...
//external API endpoints
  ...
  //ADFS: "https://sts.rackspace.com/adfs/ls/idpinitiatedsignon.aspx?RelayState=RPID%3Dbeta.selfservice.intensive.int%26RelayState%3D",
