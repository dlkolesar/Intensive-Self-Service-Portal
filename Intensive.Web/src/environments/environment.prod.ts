...
const apiServer = "https://api.selfservice.intensive.int";
const apiVersion = "v1";
const azureAppId = '471dc904-9cda-45f5-b26b-84595e9a9561';
const azureTenantId = '570057f4-73ef-41c8-bcbb-08db2fc15c2b';

export const environment = {
  production: true,
  siteTitle: "Intensive Self-Service Portal",
  appVersion: version,
...
//external API endpoints
 ...
 // ADFS: "https://sts.rackspace.com/adfs/ls/idpinitiatedsignon.aspx?RelayState=RPID%3Dselfservice.intensive.int%26RelayState%3D",
