...
namespace ActiveDirectory.GlobalRS
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string key = Configuration.GetValue<string>("CoreConfigKey");
            JObject jo = JObject.Parse(Configuration.GetValue<string>(key));
            core = new CTKAPI(jo["server"].ToString(), jo["user"].ToString(), jo["password"].ToString());
            ...
            //AddTransient because some endopoint require multiple instances of AdUser and/or AdGroup
            //AdObjectFactory is used to create these multiple instances where needed
            services.AddTransient<AdUser>(); 
            services.AddTransient<AdGroup>();
            services.AddTransient<AdComputer>();
            services.AddScoped<AdObjectFactory>();
