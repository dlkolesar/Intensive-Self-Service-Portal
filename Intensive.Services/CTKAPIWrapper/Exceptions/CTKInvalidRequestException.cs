...
namespace Intensive.Services.CTKAPIWrapper.Exceptions
{
    ...
    /// </summary>
    public class CTKInvalidRequestException : CTKHttpException
    {
                /// <summary>
        /// initializes a new instance of the class
        /// </summary>
        public CTKInvalidRequestException() : base() { }

        /// <summary>
        /// Initializes a new instance of the class with a specified error message.
        /// </summary>
        /// <param name="msg">The message that describes the error.</param>
        public CTKInvalidRequestException(string msg) : base(msg) { }
        ...
        public CTKInvalidRequestException(string msg, Exception innerException) : base(msg, innerException) { }
    }
}
